...
function categories_Bangunan_8(feature, value, size, resolution, labelText,
    ...
    switch(valueStr) {
        ...
        image: new ol.style.RegularShape({radius: 4.9091 + size, points: 6,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(5,149,105,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.76}), fill: new ol.style.Fill({color: 'rgba(5,150,105,1.0)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth, textAlign, offsetX, offsetY, overflow, repeat)
    })];
        ...
        image: new ol.style.RegularShape({radius: 4.25454 + size, points: 6,
            displacement: [0, 0], stroke: new ol.style.Stroke({color: 'rgba(73,83,96,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0.76}), fill: new ol.style.Fill({color: 'rgba(75,85,99,1.0)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth, textAlign, offsetX, offsetY, overflow, repeat)
    })];
