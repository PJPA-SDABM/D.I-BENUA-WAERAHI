...
map.getView().fit([13604033.280006, -429692.206981, 13610284.411001, -426562.606672], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">D.I BENUA WAERAHI</h2>';
        return titleElement;
    })(),
